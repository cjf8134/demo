	...
	<div class="header">
		...
		<div class="container">
			<div class="nav" style="height:100px;">
				<a href="http://www.390pay.com/" class="logo"><img src="style/images/alipay_logo.png" height="70px"></a>
				<span class="divier" style="height:50px"></span>
	...
	<div class="content">
		<form name='form1' action="pay.php" class="alipayform" method="post" target="_blank">
			...
			<div class="element">
				...
				<div class="einput"><input type="text" name="txtpartner" value="37210" readonly></div>
				<br>
			...
			<div class="element">
				...
				<div class="einput"><input type="text" name="txtkey" value="a03ca0b84eddfe52b5cd76e822f15204" readonly></div>
				<br>
			...
			<div class="element">
				...
				<div class="einput"><input type="text" name="txtpaymoney" value="0.01"></div>
				<br>
			...
			<div class="element">
				...
				<div class="einput"><input type="text" name="txtbanktype" value="ALIPAY"></div>
				<br>
				<div class="mark">注意：支付类型参数名 banktype ，扫码支付: ALIPAY ，WAP支付: ALIPAYWAP(必填)</div>
			</div>
