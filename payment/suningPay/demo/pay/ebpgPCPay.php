...
<div class="cont">
    ...
    <div class="main">
    <form name=payForm action=ebpgPCPayApi.php method=post target="_blank">
        <table class="table-data" width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <th>支付渠道编码：</th>
                <td><input class="ui-input" type="text" name="payChannelCode" value="ABC"/>
                    </td>
            </tr>
            <tr>
                <th>支付类型编码：</th>
                <td><input class="ui-input" type="text" name="payTypeCode" value="DEBIT_NETPAY"/>
                    </td>
            </tr>
            <tr>
                <th>资金服务提供商编码：</th>
                <td><input class="ui-input" type="text" name="providerCode" value="NJABC"/>
                    </td>
            </tr>
            <tr>
                <th>页面跳转同步通知页面路径：</th>
