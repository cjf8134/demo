...
$order["payChannelCode"] = $_POST['payChannelCode'];
$order["payTypeCode"] = $_POST['payTypeCode'];
$order["providerCode"] = $_POST['providerCode'];

$payment = array();
$payment['yfbpay_account'] = "70056575";
$payment['yfbpay_Pindex'] = "0001";
$payment["payChannelCode"] = $_POST['payChannelCode'];
$payment["payTypeCode"] = $_POST['payTypeCode'];
$payment["providerCode"] = $_POST['providerCode'];

//建立请求
$pay = new yfbpay();
$html_text = $pay->get_code_ebpg($order, $payment);
echo $html_text;
