...
class queryForm
{
    ...
    function query($order)
    {
      ...
      /* 数字签名,按照字母排序 */
      $sigstr="inputCharset=UTF-8"."&merchantNo=".$merchantNo."&orderTime=".$orderTime."&outOrderNo=".$outOrderNo."&publicKeyIndex=".$publicKeyIndex."&submitTime=".$submitTime;
      ...
      $button  = '<br /><form style="text-align:center;" method="post" action="https://paytestpre.suning.com/epps-pag/apiGateway/merchantOrder/b2bQueryMerchantOrder.do" style="margin:0px;padding:0px" >';
		  //$button  .= 'sign==' .$sign;
