...
class closeOrderForm
{
    ...
    function closeOrder($order)
    {
      ...
      $button  = '<br /><form style="text-align:center;" method="post" action="https://paytestpre.suning.com/epps-pag/apiGateway/merchantOrder/closeMerchantOrder.do" style="margin:0px;padding:0px" >';
		  //$button  .= 'sign==' .$sign;
