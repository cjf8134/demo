...
class Util{
     ...
     * 对请求数据进行特殊处理
     */
    function getWebForm($params,$base64Keys,$charset,$urlParamConnectFlag){
    ...
    function parseResponse($respData,$base64Keys
     ...
     * @param paramMap
     */
    function convertReqData(&$params,$base64Keys,$charset) {
     ...
     * @param paramMap
     */
    function convertRespData(&$params,$base64Keys) {
        foreach ($base64Keys as $bs64Key){
            if(isset($params[$bs64Key])){
