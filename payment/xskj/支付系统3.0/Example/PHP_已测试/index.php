...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>支付平台--即时支付接口</title>
	</head>
	<body>
			
			
		
		<form name="direct" action="pay.php" method="post" target="_blank">
			<table width="100%" border="0">
				<tr>
					<th colspan="2" scope="col">
                        ...
                        <a href="queryOrd.php" target="_blank">订单查询</a>
						<a href="refundOrd.php" target="_blank">网银支付订单退货</a>
                        <a href="df.php" target="_blank">实时代发接口</a>
                        <a href="dfqueryOrd.php" target="_blank">代发查询接口</a>
					</th>
				</tr>
                <tr>
