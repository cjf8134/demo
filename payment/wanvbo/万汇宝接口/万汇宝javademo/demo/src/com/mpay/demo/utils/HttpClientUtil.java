...
public class HttpClientUtil {
	...
	public static void asynPost(String url, Map<String, String> header, Map<String, String> param, HttpEntity entity) {
	...
	public static void asynPost(String url, Map<String, String> param) {
		executor.execute(new Runnable() {
			@Override
			public void run() {
				post(url, param);
