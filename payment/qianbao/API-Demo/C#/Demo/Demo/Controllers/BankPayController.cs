...
namespace Demo.Controllers
{
    public class BankPayController : Controller
    {
        ...
        /// 支付提交地址
        /// </summary>
        public const string submit_url = "https://csewallet.com/CSEPay/DirectPay";
        //public const string submit_url = "http://localhost:60318/CSEPay/DirectPay";
            ...
            decimal order_amount)
        {
            ...
            string fund_type = "CNH";//支付货币类型 目前只支持 CNH
