...
namespace Demo.Controllers
{
    public class HomeController : Controller
    {
        ...
        /// 支付提交地址
        /// </summary>
        public const string submit_url = "https://csewallet.com/CSEPay/Pay";
        //public const string submit_url = "http://localhost:60318/CSEPay/Pay";
        ...
        [HttpPost]
        public ActionResult Index(string orderId,string orderInfo,string product_name,string product_code,decimal order_amount)
        {
            ...
            string offline_notify = root + "/home/PayNotify";//支付成功后异步通知地址
            string page_notify = root + "/home/ReturnPage";//支付成功后同步通知地址
        ...
        private void log(string message)
        {
            ...
            System.IO.File.WriteAllText(path+"/"+ fileName, message,Encoding.UTF8);
        }
