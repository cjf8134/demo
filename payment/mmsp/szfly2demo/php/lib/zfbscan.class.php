...
class zfbscan extends base
{
     ...
     * @param string $value
     **/
    public function SetALIPAY_USER_ID($value)
    {
        $this->Body['ALIPAY_USER_ID'] = $value;
    }
     ...
     * @return 值
     **/
    public function GetALIPAY_USER_ID()
    {
        return $this->Body['ALIPAY_USER_ID'];
    }
     ...
     * @return true 或 false
     **/
    public function IsALIPAY_USER_IDSet()
    {
        return array_key_exists('ALIPAY_USER_ID', $this->Body);
    }
     ...
     * @param string $value
     **/
    public function SetALIPAY_ACCOUNT($value)
    {
        $this->Body['ALIPAY_ACCOUNT'] = $value;
    }
     ...
     * @return 值
     **/
    public function GetALIPAY_ACCOUNT()
    {
        return $this->Body['ALIPAY_ACCOUNT'];
    }
