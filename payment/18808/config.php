...
//define('PAY_URL', 'http://testpayment.shenbianhui.cn/DirectPay/Index'); //接口地址
define('PAY_URL', 'http://wg.yoyipay.com/DirectPay/Index'); //接口地址

define('M_ID', '9001003475');   // 商户号100000024
define('APP_KEY', '66e36e230dace228579dbe0627b94ffe');    //key
